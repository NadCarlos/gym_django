...
from rehabilitacion.views.pacientes_rehab import(
    ...
    PacienteRehabToCsv,
    PacienteAltasToCsv,
    PacientesAltasToCreateOnlyUseOnce,
)
...
pacientes = [
    ...
    path(route='pacientes/generate_altas_for_gimnasio',view=PacientesAltasToCreateOnlyUseOnce.as_view(), name='generate_altas_for_gimnasio'),
]
